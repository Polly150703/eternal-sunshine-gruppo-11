  ...
  return {
        ...
        controller: function($scope, $element, $window) {
            ...
            $scope.createGrid = function(ctx, p, h) {
                ...
                ctx.strokeStyle = "#4D4D4D";
                ctx.stroke(title);
                ctx.fillText("M-D", p/3-280, 30);
                ctx.fillText("J-C", p/3-120, 30);
                ctx.fillText("P-C", p/3+25, 30);
                ctx.fillText("M-D", p*2/3-80, 30);
                ctx.fillText("J-C", p*2/3+75, 30);
                ctx.fillText("P-C", p*2/3+225, 30);
                path.closePath();
            }
